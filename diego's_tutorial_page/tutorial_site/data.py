...
pcalc = [{"topic": "Trig",
         ...
         {"topic": "Logarithmic Functions",
          ...
          "sizex": 1,"sizey": 1,
          "video": "none", #put none if no video is included
          "description": "Logarithmic Functions is the power to which a number must be raised in order to get some other number. This is a simple topic to learn and isn’t widely used throughout calc."
          },
